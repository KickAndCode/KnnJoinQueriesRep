...
public class Imp2Setting1 {
  ...
  public static double queryWidth = 25000; // Query Dataset
  public static String queryTable = "200kW25k"; //Query table
  ...
  public static void main(String[] args) throws IOException, URISyntaxException 
  {
    ...
    constructQuadTree(); // applying the quad tree structure
    py.setK(k);
    table.setK(k);

    BufferedWriter resu = new BufferedWriter(new FileWriter("/home/shadoop/Data/Results20kkW10k-200kW25k.csv",true)) ; //Results file 
    BufferedReader br = new BufferedReader(new FileReader("/home/shadoop/Data/200kIndexedW25k/heads-r-00000")); // Query index file 
    String readIndex="";
